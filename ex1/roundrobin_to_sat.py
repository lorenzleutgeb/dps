...
def play(position, team, field, week):
	return encode((position, field, week, team - position), factors) + 1
...
for (w1, w2, f1, f2, t1) in product(weeks, weeks, fields, fields, teams):
	if w1 == w2:
		continue
...
# 6
# No team plays more than twice in the same
# field over the course of the season.
for (team, field, w1, r1, r2, r3) in product(teams, fields, weeks, positions, positions, positions):
	rs = [r1, r2, r3]
	if (0 in rs and team is N-1) or (1 in rs and team is 0):
		continue
